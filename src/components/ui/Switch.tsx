...
>(({ className, ...props }, ref) => (
    <SwitchPrimitives.Root
        ...
        ref={ref}
    >
        <SwitchPrimitives.Thumb className="bg-background pointer-events-none block h-5 w-5 rounded-full shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-5 data-[state=unchecked]:translate-x-0" />
    </SwitchPrimitives.Root>
));
